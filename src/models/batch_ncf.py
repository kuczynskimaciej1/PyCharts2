...
numeric_features_train = scaler.fit_transform(X_train.drop(columns=['track_id', 'artist_id', 'release_id']))
...
# Budowa modelu
model_ncf = Model(inputs=[track_input, artist_input, release_input, numeric_input], outputs=output_layer)
